...
- **Tapis chauffant** : interpolation linéaire sur la table fournie (densité catalogue ≈0,040-0,042 W/cm² sur 1/3 de surface). Correction hauteur (0,8-1,35×) et coefficient matériau. Limites matière : verre 0,055 W/cm², bois 0,065 W/cm², PVC 0,050 W/cm², acrylique 0,045 W/cm². Tension recommandée 12 V ≤18 W sinon 24 V. Sources : fiches fabricants tapis 12/24 V type Zoo Med ReptiTherm et Habistat (0,03-0,06 W/cm² mesurés à 25 °C) = **norme/catalogue** ; plafond verre 0,055 W/cm² appliqué avec marge 10 % (= **prudent**).
- **Câble chauffant** : densité cible par matériau (verre 0,03-0,04 W/cm², bois 0,04-0,05 W/cm², PVC/PMMA 0,028-0,035 W/cm²). Longueur = max(densité cible, couverture serpentin pas 2,5-10 cm). Puissance linéique saisie (W/m), tension 12/24 V (230 V seulement à titre théorique). Avertissements si spires <3 cm ou densité >90 % de la limite. Sources : tableaux Exo Terra Forest/Desert Heat Cable 15-50 W (0,8-1,3 m·W/cm²) = **catalogue** ; limitation PVC/PMMA abaissée 10-20 % pour déformation thermique (= **prudent**), SELV selon NF C 15-100/CE basse tension.
- **Éclairage 6500K / UVA / UVB** : lux cibles par milieu (8-20 klux). UVI cible via zones de Ferguson : zone 1 nocturne 0-1, zone 2 forêt 0,7-2, zone 3 tropical 1-3, zone 4 désert 3-6. Modèle 1/r² depuis la distance de référence fournie par l’utilisateur. Avertissements si UVI total >120 % ou <80 % de la plage. Sources : Ferguson et al. 2010 (zones UVI) = **norme scientifique** ; courbes Arcadia T5/Exo Terra UVB (1-1,5 UVI à 30 cm) = **catalogue** ; marge de sécurité ±20 % appliquée aux alertes.
- **Substrat** : densités techniques (kg/L) : terreau 0,65-0,85 ; fibre coco 0,45-0,65 ; mélange forestier 0,60-0,80 ; sable 1,5-1,7 ; sable/terre 1,0-1,3. Masse calculée en min/max/nominal. +10 % conseillé pour tassement. Sources : fiches horticoles NF U44-551 pour terreaux (= **norme**), blocs coco 5 kg compressés (70-80 L) et granulats siliceux (EN 13139) = **catalogue** ; ajout marge +10 % tassement (= **prudent**).
- **Brumisation** : couverture par buse (0,08-0,16 m²) selon milieu. Débits typiques 60-120 mL/min par busette fine. Volume quotidien = débit × durée × cycles × nb buses. Réservoir = volume quotidien × autonomie (input) ×1,2, plus affichage direct pour 3 et 7 jours. Avertissement si densité de buses >10/m². Sources : datasheets MistKing/ExoTerra (0,08-0,12 L/h à 60 psi) = **catalogue** ; réservoir surdimensionné +20 % pour éviter désamorçage (= **prudent**).
